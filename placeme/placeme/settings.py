...
SECRET_KEY = 'django-insecure-0-l81!yu-0)4-icsq9@n5d1$bl76jr1mc4s15wl1d@uiak44_m'
...
AUTHENTICATION_BACKENDS = [
    'main.backends.EmailAuthBackend',  # Use your custom backend
    'django.contrib.auth.backends.ModelBackend',  # Optionally keep this for admin/superuser login
]
